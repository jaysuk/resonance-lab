...
// The self-update module is shared with the 3.6 build, so it reaches DWC through the same host
// adapter as everything else rather than importing Pinia itself.
